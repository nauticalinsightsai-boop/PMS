...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    ...
    return [
      ...
      { source: '/dashboard/site-system/home', destination: '/dashboard/site-system/media-library', permanent: true },
      { source: '/dashboard/site-system/pages/:path*', destination: '/dashboard/site-system/media-library', permanent: true },
      { source: '/dashboard/site-system/website-data', destination: '/dashboard/site-system/media-library', permanent: true },
