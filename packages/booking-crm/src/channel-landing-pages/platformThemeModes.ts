...
export const PLATFORM_DARK_OVERRIDES: Record<string, Partial<PlatformPortalTheme>> = {
  ...
  website: {
    ...
    text: '#E6EDF7',
    textMuted: '#A9B7D0',
    cardBg: 'rgba(11, 21, 58, 0.74)',
    cardBorder: 'rgba(0, 75, 142, 0.24)',
    quoteBg: 'rgba(11, 21, 58, 0.7)',
    quoteBorder: '#3FEFE0',
    heroBg: '#004B8E',
    heroText: '#E6EDF7',
    primary: '#004B8E',
    ...
    accentForeground: '#010528',
    contextColor: '#004B8E',
    linkColor: '#004B8E',
    recommendedBg: '#004B8E',
    recommendedText: '#FFFFFF',
    freeBadgeBg: '#14291F',
    freeBadgeText: '#4ADE80',
    priceBadgeBg: 'rgba(0, 75, 142, 0.55)',
