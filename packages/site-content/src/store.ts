    ...
    products: [
      {
        ...
        rating: 4.9,
        reviewCount: 1240,
        imageUrl: '/images/marketing/membership-templates-500.webp',
        visible: true,
        sortOrder: 0,
      },
      {
      ...
      },
      {
        ...
        rating: 4.7,
        reviewCount: 420,
        imageUrl: '/images/marketing/membership-guides-500.webp',
        visible: true,
        sortOrder: 2,
      },
      {
        ...
        rating: 4.9,
        reviewCount: 2100,
        imageUrl: '/images/marketing/membership-tools-500.webp',
        visible: true,
        sortOrder: 3,
      },
      {
        ...
        rating: 4.8,
        reviewCount: 310,
        imageUrl: '/images/marketing/community-workshop-600.webp',
        visible: true,
        sortOrder: 4,
      },
      {
        ...
        rating: 4.6,
        reviewCount: 180,
        imageUrl: '/images/marketing/membership-webinars-500.webp',
        visible: true,
        sortOrder: 5,
      },
    ],
