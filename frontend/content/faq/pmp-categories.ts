...
export const PMP_FAQ_CATEGORIES: PmpFaqCategory[] = [
  ...
  { id: 'eligibility-application-contact-hours', label: 'Eligibility, Application & 35 Contact Hours', hubH2: 'Eligibility & application', order: 14 },
...
export const LEGACY_PMP_CATEGORY_MAP: Record<string, PmpCategoryId> = {
  ...
  'Eligibility, Application, 35 Contact Hours': 'eligibility-application-contact-hours',
