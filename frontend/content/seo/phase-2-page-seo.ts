...
export const PHASE_2_PAGE_SEO: Record<string, PageSeoConfig> = {
  ...
  '/certifications': {
    ...
    title: 'Project Management Courses | PM Structure',
    description:
      'Project Management Courses: explore PMP, Agile, Primavera P6, risk management and Microsoft Project training with live classes and expert support. Start today.',
