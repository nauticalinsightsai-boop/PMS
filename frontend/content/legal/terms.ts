...
export const termsDocument: LegalDocument = {
  ...
  sections: [
    ...
    section(
      'payments',
      '4. Payments & refunds',
      `Tuition, membership, and service fees are shown at checkout with applicable regional pricing. Official exam fees, certification-body fees, taxes, and third-party charges are excluded unless stated otherwise. See our [Refunds & Cancellations](/legal/refunds) and [Membership Terms](/legal/membership-terms). Email ${LEGAL_SUPPORT_EMAIL} for billing disputes with your order email and offering ID.`,
    ),
    section(
      'ip',
    ...
    section(
      'contact',
      '10. Contact',
      `Data controller: ${LEGAL_CONTROLLER_LINE}. ${legalSupportSection('these Terms')}`,
    ),
  ],
};
