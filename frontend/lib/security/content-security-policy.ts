const directives = [
  ...
  "connect-src 'self' https://www.google-analytics.com https://region1.google-analytics.com https://www.facebook.com https://graph.facebook.com https://*.supabase.co wss://*.supabase.co https://api.stripe.com https://api.calendly.com",
