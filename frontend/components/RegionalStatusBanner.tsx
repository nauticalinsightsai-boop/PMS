...
export function RegionalStatusBanner({ status, message }: RegionalStatusBannerProps) {
  ...
  return (
    <div className="mb-4 flex gap-3 rounded-2xl border border-amber-200/80 bg-amber-50/90 px-4 py-3 text-sm text-amber-950 dark:border-amber-900/50 dark:bg-amber-950/30 dark:text-amber-100">
