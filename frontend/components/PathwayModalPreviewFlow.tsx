      ...
      {step === 'roadmap' ? (
        ...
        <section key="materials" className="animate-in fade-in slide-in-from-right-4 duration-300 space-y-4">
          <div>
            ...
            <p className="text-xs font-medium text-slate-500 dark:text-slate-400">
              Watch the overview, then open the guide or slides in a new tab.
            </p>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {guideUrl ? (
              <DocumentLinkButton
                ...
                description={guidePanel?.description ?? 'Chapter 0: programme foundation (opens in a new tab).'}
                icon={FileText}
              />
            ) : (
            ...
            {slidesUrl ? (
              <DocumentLinkButton
                ...
                description={slidesPanel?.description ?? 'D0: 2026 PMP Navigator deck (opens in a new tab).'}
                icon={Presentation}
              />
            ) : (
