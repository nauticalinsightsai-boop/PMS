...
import { legalHubSections } from '@/content/legal';
            ...
            <div key={section.title}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {section.cards.map((card) => (
                  ...
                  >
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white group-hover:text-brand-orange transition-colors">
                      {card.title}
                    </h3>
