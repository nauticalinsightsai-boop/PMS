      ...
      <div className="container mx-auto px-4 py-16 md:py-24">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-carbon dark:text-slate-400 font-medium">
              <li><Link href="/certifications" className="hover:text-brand-orange transition-colors">PMP® Certification</Link></li>
              <li><Link href="/certifications" className="hover:text-brand-orange transition-colors">CAPM® Certification</Link></li>
              <li><Link href="/certifications" className="hover:text-brand-orange transition-colors">PMI-ACP® Agile</Link></li>
              <li><Link href="/certifications" className="hover:text-brand-orange transition-colors">PRINCE2® Foundation</Link></li>
              <li><Link href="/certifications" className="hover:text-brand-orange transition-colors">Six Sigma Green Belt</Link></li>
              <li><Link href="/compare" className="hover:text-brand-orange font-bold text-brand-orange/80">Compare All Certs</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-carbon dark:text-slate-400 font-medium">
              <li><Link href="/newsletter" className="hover:text-brand-orange transition-colors">Newsletter & Insights</Link></li>
              <li><Link href="/store" className="hover:text-brand-orange transition-colors">Study Resources Store</Link></li>
              <li><Link href="/community" className="hover:text-brand-orange transition-colors">Community Network</Link></li>
              <li><Link href="/faq" className="hover:text-brand-orange transition-colors">Help & FAQ</Link></li>
              <li><Link href="#" className="hover:text-brand-orange transition-colors">CV Maker Tool</Link></li>
              <li><Link href="#" className="hover:text-brand-orange transition-colors">Study Planner</Link></li>
            </ul>
          </div>
        ...
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          <div className="flex flex-wrap justify-center gap-6 text-xs text-carbon dark:text-slate-500 font-medium">
            ...
            <Link href="#" className="hover:text-brand-orange transition-colors">Cookie Policy</Link>
          </div>
