          ...
          <Sheet>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px] bg-ivory dark:bg-obsidian">
              <nav className="flex flex-col gap-4 mt-8">
                <Link to="/" className="text-lg font-medium hover:text-brand-orange transition-colors">Home</Link>
                <Link to="/pm-service" className="text-lg font-medium hover:text-brand-orange transition-colors">Service</Link>
                <Link to="/certifications" className="text-lg font-medium hover:text-brand-orange transition-colors">Certifications</Link>
                <Link to="/newsletter" className="text-lg font-medium hover:text-brand-orange transition-colors">Newsletter</Link>
                <Link to="/community" className="text-lg font-medium hover:text-brand-orange transition-colors">Community</Link>
                <Link to="/store" className="text-lg font-medium hover:text-brand-orange transition-colors">Store</Link>
                <Link to="/membership" className="text-lg font-medium hover:text-brand-orange transition-colors">Membership</Link>
                <Link to="/about" className="text-lg font-medium hover:text-brand-orange transition-colors">About</Link>
